...
3. If running: report description, project, task, start time, duration so far, and inactivity (`pastThreshold`) when `entry_methods.automated.inactivity` is enabled.
