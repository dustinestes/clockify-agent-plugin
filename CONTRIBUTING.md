...
1. Branch from `main`.
2. Keep subscriber docs (README, use, troubleshoot, logging, config, schema) separate from maintainer docs (develop, publish, structure) unless a rename forces a link update.
