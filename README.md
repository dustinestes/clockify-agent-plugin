...
| Mode | [`clockify-automate`](skills/clockify-automate/SKILL.md) | Agent mode on: forge + Cursor Plan/Debug, ensure, rules from `entry.automated` | `/clockify-automate` |
| Mode | [`clockify-unautomate`](skills/clockify-unautomate/SKILL.md) | Agent mode off: remove rule/hooks; disable automation flags in yaml; keep `.clockify/` | `/clockify-unautomate` |
